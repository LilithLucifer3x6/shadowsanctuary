...
// The file currently has a corrupted block at the end starting with "NO STUBS, NO MOCKS"
// We will replace everything from that section down.
const corruptedRegex = /===================================================================\r?\nNO STUBS, NO MOCKS[\s\S]*$/;
