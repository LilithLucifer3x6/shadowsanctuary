...
(async () => {
  ...
  // Wait up to 15s for the textarea to appear
  await page.waitForSelector('textarea, input[type="text"]', { timeout: 15000 }).catch(() => {});
  ...
  if (input) {
    ...
    console.log('Input never appeared. Initial response hung?');
  }
