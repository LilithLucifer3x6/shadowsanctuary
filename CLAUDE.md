...
- **6-Domain Intake Requirement:** Intake must evaluate all six domains (Crown, Gaze, Grin, Visage, Veil, Vessel) with identical evaluation depth. It cannot simply ask for "general concerns." The AI or fast-path flow must specifically gather concerns for the scalp/hair, under-eyes/lashes, gums/teeth, facial skin, makeup/color cosmetics, and body skin using domain-specific, AI-generated, open-ended pools. This follows the Guided Conversation Guardrails (Rule 18), ensuring meaningful follow-up for each domain before considering the intake section complete.
