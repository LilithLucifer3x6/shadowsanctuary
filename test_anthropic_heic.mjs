...
async function main() {
  ...
  const mediaType = 'image/heic';
  
  const images = [
    { base64, mediaType, filename: 'test1.jpg' }
  ];
  
  console.log("Simulating parseBatchProductImages with 1 image...");
          ...
          products: {
            ...
            items: {
              ...
              properties: {
                ...
                ingredient_conflicts: { type: 'boolean' }
              },
