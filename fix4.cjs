...
// The bottom of the file structure in App.jsx looks like:
...
const endTargetSearch = `                  }} className="btn g" style={{ width: '100%' }}>Raze the Sanctuary to Ash</button>
                </div>
...
const endTargetReplace = `                  }} className="btn g" style={{ width: '100%' }}>Raze the Sanctuary to Ash</button>
                </div>
...
c = c.replace(endTargetSearch, endTargetReplace);
