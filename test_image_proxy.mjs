...
async function main() {
  ...
  if (result.output) {
    ...
    await sharp(Buffer.from(buf))
      .jpeg()
      .toFile('public/assets/flowing_ceremonial_mahogany_flux_pro_corrected_locks_test.jpg');
    console.log("Saved to public/assets/flowing_ceremonial_mahogany_flux_pro_corrected_locks_test.jpg");
  } else {
