...
const endBlockSearch = `                  }} className="btn g" style={{ width: '100%' }}>Raze the Sanctuary to Ash</button>
                </div>
...
const endBlockReplace = `                  }} className="btn g" style={{ width: '100%' }}>Raze the Sanctuary to Ash</button>
                </div>
...
c = c.replace(endBlockSearch, endBlockReplace);
