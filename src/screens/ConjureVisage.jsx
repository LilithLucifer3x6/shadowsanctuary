...
export const ROOM_PROMPTS = {
  rites:  (cfg) => `Hand-painted 2D animated dark-fantasy illustration of a mystical Keeper. Plus size, full figure body type. Dark rich umber skin, and ${cfg.locStyle} extremely fine, thread-thin microlocs, each strand clearly individually visible, no thicker than embroidery floss adorned with ${cfg.hairAccessory}. Wearing an extravagantly opulent deep ${cfg.robeColor} robe of ${cfg.robeDesign} design — the wardrobe of a Victorian-era vampiric noble, dripping in opulence as though an entire country's treasury were behind it: dense silver embroidery, intricate beadwork, jeweled clasps, high structured collars, dramatic fitted sleeves, ornate brooches and cameos, dark romantic elegance, rich brocade and heavy embellished trim, sumptuous and expensive-looking in every detail, adorned with ${cfg.jewelry} jewelry. Standing in a grand candlelit chamber of an ornate forest manor, a roaring fireplace and cauldron before them, brewing a skincare potion. Their ${cfg.familiar} familiar watches nearby. Lush painterly backgrounds, expressive stylized character design, gothic dark-fantasy video-game aesthetic, richly detailed candlelit interiors, moody atmospheric lighting with dramatic shadows and ornate gothic architecture. No velvet texture anywhere; prefer flowing silk, brocade, or heavy wool-like fabrics instead. Soft glowing aura, calm expression.`,
  grim:   (cfg) => `Hand-painted 2D animated dark-fantasy illustration of a mystical Keeper. Plus size, full figure body type. Dark rich umber skin, and ${cfg.locStyle} extremely fine, thread-thin microlocs, each strand clearly individually visible, no thicker than embroidery floss adorned with ${cfg.hairAccessory}. Wearing an extravagantly opulent deep ${cfg.robeColor} robe of ${cfg.robeDesign} design — the wardrobe of a Victorian-era vampiric noble, dripping in opulence as though an entire country's treasury were behind it: dense silver embroidery, intricate beadwork, jeweled clasps, high structured collars, dramatic fitted sleeves, ornate brooches and cameos, dark romantic elegance, rich brocade and heavy embellished trim, sumptuous and expensive-looking in every detail. Standing before towering shelves of glowing potion bottles in a dark magical library, examining a product label. Their ${cfg.familiar} familiar perches nearby. Lush painterly backgrounds, expressive stylized character design, gothic dark-fantasy video-game aesthetic, richly detailed candlelit interiors, moody atmospheric lighting with dramatic shadows and ornate gothic architecture. No velvet texture anywhere; prefer flowing silk, brocade, or heavy wool-like fabrics instead. Soft glowing aura, calm expression.`,
  ...
  root:   (cfg) => `Hand-painted 2D animated dark-fantasy illustration of a mystical Keeper. Plus size, full figure body type. Dark rich umber skin, and ${cfg.locStyle} extremely fine, thread-thin microlocs, each strand clearly individually visible, no thicker than embroidery floss adorned with ${cfg.hairAccessory}. Wearing an extravagantly opulent deep ${cfg.robeColor} robe of ${cfg.robeDesign} design — the wardrobe of a Victorian-era vampiric noble, dripping in opulence as though an entire country's treasury were behind it: dense silver embroidery, intricate beadwork, jeweled clasps, high structured collars, dramatic fitted sleeves, ornate brooches and cameos, dark romantic elegance, rich brocade and heavy embellished trim, sumptuous and expensive-looking in every detail. Casting spells over a large bubbling cauldron, magical glowing symbols forming in the air. Their ${cfg.familiar} familiar watches from a wooden beam above. Lush painterly backgrounds, expressive stylized character design, gothic dark-fantasy video-game aesthetic, richly detailed candlelit interiors, moody atmospheric lighting with dramatic shadows and ornate gothic architecture. No velvet texture anywhere; prefer flowing silk, brocade, or heavy wool-like fabrics instead. Soft glowing aura, calm expression.`,
