...
export const ROOM_PROMPTS = {
  rites:  (cfg) => `Hand-painted 2D animated dark-fantasy illustration of a mystical Keeper. Plus size, full figure body type. Dark rich umber skin, and ${cfg.locStyle} extremely fine, thread-thin microlocs, each strand clearly individually visible, no thicker than embroidery floss adorned with ${cfg.hairAccessory}. Wearing an extravagantly opulent deep ${cfg.robeColor} robe of ${cfg.robeDesign} design — the wardrobe of medieval royalty or Victorian gothic aristocracy, as though an entire country's treasury were behind it: dense gold embroidery, intricate beadwork, jeweled clasps, rich brocade and heavy embellished trim, sumptuous and expensive-looking in every detail, adorned with ${cfg.jewelry} jewelry. Standing in a cozy witchy cottage interior with a fireplace and cauldron, brewing a skincare potion. Their ${cfg.familiar} familiar watches nearby. Lush painterly backgrounds, expressive stylized character design, gothic dark-fantasy video-game aesthetic, richly detailed candlelit interiors, moody atmospheric lighting with dramatic shadows and ornate gothic architecture. No velvet texture anywhere; prefer flowing silk, brocade, or heavy wool-like fabrics instead. Soft glowing aura, calm expression.`,
  grim:   (cfg) => `Hand-painted 2D animated dark-fantasy illustration of a mystical Keeper. Plus size, full figure body type. Dark rich umber skin, and ${cfg.locStyle} extremely fine, thread-thin microlocs, each strand clearly individually visible, no thicker than embroidery floss adorned with ${cfg.hairAccessory}. Wearing an extravagantly opulent deep ${cfg.robeColor} robe of ${cfg.robeDesign} design — the wardrobe of medieval royalty or Victorian gothic aristocracy, as though an entire country's treasury were behind it: dense gold embroidery, intricate beadwork, jeweled clasps, rich brocade and heavy embellished trim, sumptuous and expensive-looking in every detail. Standing before towering shelves of glowing potion bottles in a dark magical library, examining a product label. Their ${cfg.familiar} familiar perches nearby. Lush painterly backgrounds, expressive stylized character design, gothic dark-fantasy video-game aesthetic, richly detailed candlelit interiors, moody atmospheric lighting with dramatic shadows and ornate gothic architecture. No velvet texture anywhere; prefer flowing silk, brocade, or heavy wool-like fabrics instead. Soft glowing aura, calm expression.`,
  altars: (cfg) => `Hand-painted 2D animated dark-fantasy illustration of a mystical Keeper. Plus size, full figure body type. Dark rich umber skin, and ${cfg.locStyle} extremely fine, thread-thin microlocs, each strand clearly individually visible, no thicker than embroidery floss adorned with ${cfg.hairAccessory}. Wearing an extravagantly opulent deep ${cfg.robeColor} robe of ${cfg.robeDesign} design — the wardrobe of medieval royalty or Victorian gothic aristocracy, as though an entire country's treasury were behind it: dense gold embroidery, intricate beadwork, jeweled clasps, rich brocade and heavy embellished trim, sumptuous and expensive-looking in every detail. Sitting at a beautifully arranged altar with crystals, candles, and offerings, with hands raised in ritual gesture. Their ${cfg.familiar} familiar rests on the altar. Lush painterly backgrounds, expressive stylized character design, gothic dark-fantasy video-game aesthetic, richly detailed candlelit interiors, moody atmospheric lighting with dramatic shadows and ornate gothic architecture. No velvet texture anywhere; prefer flowing silk, brocade, or heavy wool-like fabrics instead. Soft glowing aura, calm expression.`,
  root:   (cfg) => `Hand-painted 2D animated dark-fantasy illustration of a mystical Keeper. Plus size, full figure body type. Dark rich umber skin, and ${cfg.locStyle} extremely fine, thread-thin microlocs, each strand clearly individually visible, no thicker than embroidery floss adorned with ${cfg.hairAccessory}. Wearing an extravagantly opulent deep ${cfg.robeColor} robe of ${cfg.robeDesign} design — the wardrobe of medieval royalty or Victorian gothic aristocracy, as though an entire country's treasury were behind it: dense gold embroidery, intricate beadwork, jeweled clasps, rich brocade and heavy embellished trim, sumptuous and expensive-looking in every detail. Casting spells over a large bubbling cauldron, magical glowing symbols forming in the air. Their ${cfg.familiar} familiar watches from a wooden beam above. Lush painterly backgrounds, expressive stylized character design, gothic dark-fantasy video-game aesthetic, richly detailed candlelit interiors, moody atmospheric lighting with dramatic shadows and ornate gothic architecture. No velvet texture anywhere; prefer flowing silk, brocade, or heavy wool-like fabrics instead. Soft glowing aura, calm expression.`,
  pool:   (cfg) => `Hand-painted 2D animated dark-fantasy illustration of a mystical Keeper. Plus size, full figure body type. Dark rich umber skin, and ${cfg.locStyle} extremely fine, thread-thin microlocs, each strand clearly individually visible, no thicker than embroidery floss adorned with ${cfg.hairAccessory}. Wearing an extravagantly opulent deep ${cfg.robeColor} robe of ${cfg.robeDesign} design — the wardrobe of medieval royalty or Victorian gothic aristocracy, as though an entire country's treasury were behind it: dense gold embroidery, intricate beadwork, jeweled clasps, rich brocade and heavy embellished trim, sumptuous and expensive-looking in every detail. Gazing into a glowing scrying pool with swirling visions of wisdom in the water. Their ${cfg.familiar} familiar is reflected in the water. Lush painterly backgrounds, expressive stylized character design, gothic dark-fantasy video-game aesthetic, richly detailed candlelit interiors, moody atmospheric lighting with dramatic shadows and ornate gothic architecture. No velvet texture anywhere; prefer flowing silk, brocade, or heavy wool-like fabrics instead. Soft glowing aura, calm expression.`,
  tome:   (cfg) => `Hand-painted 2D animated dark-fantasy illustration of a mystical Keeper. Plus size, full figure body type. Dark rich umber skin, and ${cfg.locStyle} extremely fine, thread-thin microlocs, each strand clearly individually visible, no thicker than embroidery floss adorned with ${cfg.hairAccessory}. Wearing an extravagantly opulent deep ${cfg.robeColor} robe of ${cfg.robeDesign} design — the wardrobe of medieval royalty or Victorian gothic aristocracy, as though an entire country's treasury were behind it: dense gold embroidery, intricate beadwork, jeweled clasps, rich brocade and heavy embellished trim, sumptuous and expensive-looking in every detail. Writing in a large leather-bound shadow tome by candlelight, surrounded by drying herbs and honey jars with a warm cup of herbal tea. Their ${cfg.familiar} familiar curls up beside the tome. Lush painterly backgrounds, expressive stylized character design, gothic dark-fantasy video-game aesthetic, richly detailed candlelit interiors, moody atmospheric lighting with dramatic shadows and ornate gothic architecture. No velvet texture anywhere; prefer flowing silk, brocade, or heavy wool-like fabrics instead. Soft glowing aura, calm expression.`,
};
