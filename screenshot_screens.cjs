...
(async () => {
  ...
  await page.setViewport({ width: 390, height: 844 }); // iPhone 12/13/14 size (close to 9:16)
  ...
  await page.screenshot({ path: 'public/assets/avatar-tests/screenshot_rites.png' });
  ...
  for (const tab of tabs) {
    ...
    await page.screenshot({ path: `public/assets/avatar-tests/screenshot_${tab.id}.png` });
  }
