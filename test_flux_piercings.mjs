...
async function main() {
  try {
    ...
    // ... we don't need to do the user creation if it already exists, just sign in
    ...
    const outPath = 'public/assets/flowing_ceremonial_mahogany_flux2_test_piercings.jpg';
